...
$service_link_raw = (!is_wp_error($services) && !empty($services)) ? get_term_link($services[0]) : $permalink;
$service_link     = (!is_wp_error($service_link_raw)) ? $service_link_raw : $permalink;
